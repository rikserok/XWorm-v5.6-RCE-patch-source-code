...
[DebuggerNonUserCode]
	...
	private void InitializeComponent()
	{
		...
		this.NotifyIcon1.Text = "XWorm V5.6 Edition by @rikserok";
		...
		this.Text = "XWorm V5.6 Edition by @rikserok";
	...
	private void Timer_Status_Tick(object sender, EventArgs e)
	{
		try
		{
			...
			Text = checked("XWorm V5.6 Edition @" + GClass19.string_3 + " " + "by @rikserok" + "   " +  DateTime.Now.ToLongTimeString() + "   CPU " + Conversions.ToString((int)Math.Round(performanceCounter1.NextValue())) + "%   RAM " + Conversions.ToString((int)Math.Round(performanceCounter2.NextValue()))) + "%";
